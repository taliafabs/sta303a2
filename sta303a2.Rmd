...
```{r, echo=FALSE, warning=FALSE, message=FALSE, include=TRUE, fig.cap="write the caption here. 2-3 sentences"}
# plot actual data
...
These results hint that there may have been excess warming between 1996 and 2025, but the 95% prediction intervals (shown by the purple dotted lines) fall both above and below the actual max temperature data, so it's inconclusive.
