...
s_1(\text{seasonal1}) = \sin\left(\frac{\pi \cdot \text{dateInt}}{182.625}\right) + \cos\left(\frac{\pi \cdot \text{dateInt}}{182.625}\right) \\
s_2(\text{seasonal2}) = \sin\left(\frac{\pi \cdot \text{dateInt}}{91.3125}\right) + \cos\left(\frac{\pi \cdot \text{dateInt}}{91.3125}\right)
$$
$$
\text{Res2:} \\
Y_i \sim \mathcal{N}(\mu_i, \sigma^2) \\
...
Figure Caption:
The first plot shows the prediction intervals for the random effect of year on maximum temperature,
showing the predicted unexplained variation by year. The second plot presents several simulated trends of the smoothing effect 
