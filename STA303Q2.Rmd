...
matplot(newdat$Date, simulated_temperatures, 
        type = "l", 
        lty = 1, 
        col = RColorBrewer::brewer.pal(ncol(simulated_temperatures), "Paired"), 
        xaxt = "n", 
        xaxs = "i", 
        yaxs = "i", 
        ylim = range(simulated_temperatures),
        ylab = "", 
        xlab = "Year")

matlines(newdat$Date, predTrend + baseline_temp, 
         lty = c(1, 2, 2), 
         col = "black", 
         lwd = 2)
